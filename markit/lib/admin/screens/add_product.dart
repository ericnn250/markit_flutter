...
import 'package:markit/admin/db/product.dart';
...
class _AddProductState extends State<AddProduct> {
  ...
  bool onSale = false;
  bool featured = false;
PickedFile _image,_image1,_image2,_image3;
 // File _image1;
        ...
        child: SingleChildScrollView(
          child: isLoading
            ...
            children: <Widget>[
              ...
              Text('Main Product Image',style: TextStyle(fontWeight: FontWeight.w900),),
              SizedBox(height: 10.0,),
              Row(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text('Other Image',style: TextStyle(fontWeight: FontWeight.w900),),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text('(Optional)',),
                    ),
              ...
              SizedBox(height: 10.0,),
              Text('Available Colors',style: TextStyle(fontWeight: FontWeight.w900),),
              SizedBox(height: 10.0,),
              ...
              SizedBox(height: 10.0,),
              Text('Available Sizes',style: TextStyle(fontWeight: FontWeight.w900) ,),
              SizedBox(height: 10.0,),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Column(
...
//
  ...
  void _selectImage(PickedFile tempImg,int imageNumber) async {
    //File tempImg = await pickImage;

    switch(imageNumber){
      case 0: setState(() => _image = tempImg);
      break;
